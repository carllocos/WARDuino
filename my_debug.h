...
const char *all_opcodes[] = {"0x00 unreachable", "0x01 nop", "0x02 block", "0x03 loop", "0x04 if", "0x05 else",
...
const char *my_opcode_repr(uint8_t opcode) {
    if (opcode < 192) {
        return all_opcodes[opcode];
    } else {
